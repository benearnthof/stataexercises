...
*** Schritt 3: Kreuztabellen mit Drittvariable


***Schritt 4: Bewertung Drittvariableneffekt
* Falls es sich um einen Mediator oder Confounder handeln sollte, überlegen Sie
* sich das zugehörige Kausalschema (zeichnen Sie es auf!) und begründen Sie 
* den gefundenen Drittvariableneffekt!
...
*** Lösungshinweis Aufgabe § 2:
	...
	*Variable und Werte labeln
	label var kirchgang "Kirchgangshäufigket"
	lab def sö 0"selten/nie" 1"öfter"
	lab val kirchgang sö
	...
	*Variable und Werte labeln
	...
	lab def konf 1"evangelisch" 2"römisch-katholisch" 3"konfessionslos"
	lab val konfession konf
...
*Gesundheitszustand: 
	...
	gen gesund=.
	replace gesund=1 if hs01==1 | hs01==2
	replace gesund=0 if hs01==3 | hs01==4 | hs01==5
	
	lab var gesund "Gesundheitszustand (Dummy)"
	lab def ges 1"gut" 0"schlecht"
	lab val gesund ges
